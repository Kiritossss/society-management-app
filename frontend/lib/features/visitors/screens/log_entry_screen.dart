...
class _LogEntryScreenState extends ConsumerState<LogEntryScreen> {
  ...
  Future<void> _submit() async {
    ...
    final success = await ref.read(visitorProvider.notifier).logEntry(
    ...
    if (success && mounted) {
      ScaffoldMessenger.of(context).showSnackBar(
        const SnackBar(content: Text('Visitor logged'), backgroundColor: AppColors.success),
      );
      context.pop();
    }
  }
